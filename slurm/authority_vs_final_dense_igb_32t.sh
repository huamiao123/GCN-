...
#SBATCH -t 00:50:00
#SBATCH -J auth_vs_dense
#SBATCH -o /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/auth_vs_dense_%j.out
#SBATCH -e /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/auth_vs_dense_%j.err
...
export SCOPE_OUTPUT="$root/results/authority_vs_final_dense/igb_d2983_l2_32t.json"
export TFS_WORKER_CPUS="$(taskset -pc $$ | sed 's/.*: //')"
mkdir -p "$root/results/authority_vs_final_dense"
