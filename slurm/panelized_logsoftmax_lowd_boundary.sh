...
#SBATCH --array=0-11%6
#SBATCH -J logsm_lowd
#SBATCH -o /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/logsm_lowd_%A_%a.out
#SBATCH -e /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/logsm_lowd_%A_%a.err
...
export SCOPE_OUTPUT="$root/results/panelized_logsoftmax_lowd/d${dim}_${threads}t.json"
export TFS_WORKER_CPUS="$(taskset -pc $$ | sed 's/.*: //')"
mkdir -p "$root/results/panelized_logsoftmax_lowd"
