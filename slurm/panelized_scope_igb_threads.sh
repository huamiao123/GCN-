...
#SBATCH -t 01:30:00
#SBATCH --array=0-2%3
#SBATCH -J panel_scope_thr
#SBATCH -o /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/panel_scope_thr_%A_%a.out
#SBATCH -e /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/panel_scope_thr_%A_%a.err
...
export SCOPE_OUTPUT="$root/results/panelized_scope_igb_d2983_l2_${threads}t.json"
