...
#SBATCH -t 00:45:00
#SBATCH -J native_logits
#SBATCH -o /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/native_logits_%j.out
#SBATCH -e /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/native_logits_%j.err
...
export PYTHONPATH="$root/build_compact_logits/extension:$root/python:$root/csrc:$root/tests"
...
export SCOPE_OUTPUT="$root/results/native_logits_scope_igb/d2983_32t.json"
export TFS_WORKER_CPUS="$(taskset -pc $$ | sed 's/.*: //')"
mkdir -p "$root/results/native_logits_scope_igb"
