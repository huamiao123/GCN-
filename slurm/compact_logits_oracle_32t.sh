...
#SBATCH -t 00:15:00
#SBATCH -J logits_oracle
#SBATCH -o /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/logits_oracle_%j.out
#SBATCH -e /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/logits_oracle_%j.err
...
mkdir -p "$root/results/compact_logits_v2_oracle"
numactl --cpunodebind=0-3 --localalloc python -u \
  "$root/tests/bench_compact_logits_amx_shadow.py" \
  --output "$root/results/compact_logits_v2_oracle/d2983_32t.json"
