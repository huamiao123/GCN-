...
#SBATCH --array=0-3
#SBATCH -J logsm_full
#SBATCH -o /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/logsm_full_%A_%a.out
#SBATCH -e /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/logsm_full_%A_%a.err
...
export SCOPE_THREADS=32 SCOPE_LAYERS=2 SCOPE_WARMUPS=1 SCOPE_REPEATS=7
...
export SCOPE_OUTPUT="$root/results/panelized_logsoftmax_full/d${dim}_32t.json"
export TFS_WORKER_CPUS="$(taskset -pc $$ | sed 's/.*: //')"
mkdir -p "$root/results/panelized_logsoftmax_full"
