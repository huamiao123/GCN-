...
#SBATCH -t 01:30:00
#SBATCH --array=0-11%6
#SBATCH -J panel_dim_sweep
#SBATCH -o /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/panel_dim_%A_%a.out
#SBATCH -e /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/panel_dim_%A_%a.err

set -euo pipefail
root=/online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905
dims=(256 256 256 512 512 512 1024 1024 1024 2048 2048 2048)
thread_values=(1 8 32 1 8 32 1 8 32 1 8 32)
...
export SCOPE_OUT_DIM=$out_dim SCOPE_SYNTHETIC_LABELS=1
export TFS_SCOPE_BACKWARD_ORDER=q_first
export TFS_SCOPE_LOSS_ROW_TILE=300000 TFS_SCOPE_FUSED_DB=1
export SCOPE_OUTPUT="$root/results/panelized_dimension_sweep/d${out_dim}_${threads}t.json"
export TFS_WORKER_CPUS="$(taskset -pc $$ | sed 's/.*: //')"
mkdir -p "$root/results/panelized_dimension_sweep"
