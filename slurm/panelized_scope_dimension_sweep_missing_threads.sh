...
#SBATCH -t 01:30:00
#SBATCH --array=0-14%6
#SBATCH -J panel_dim_more
#SBATCH -o /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/panel_dim_more_%A_%a.out
#SBATCH -e /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/panel_dim_more_%A_%a.err

set -euo pipefail
root=/online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905
dims=(256 512 1024 2048 2983)
thread_values=(2 4 16)
index=${SLURM_ARRAY_TASK_ID:?}
dim_index=$((index / 3))
thread_index=$((index % 3))
