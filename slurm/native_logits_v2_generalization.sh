...
#SBATCH -t 00:50:00
#SBATCH --array=0-7%8
#SBATCH -J logits_shape
#SBATCH -o /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/logits_shape_%A_%a.out
#SBATCH -e /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/logits_shape_%A_%a.err
...
export SCOPE_OUT_DIM=$dim SCOPE_SYNTHETIC_LABELS=1 SCOPE_AB_KIND=logits
export TFS_SCOPE_BACKWARD_ORDER=q_first TFS_SCOPE_FUSED_DB=1 TFS_SCOPE_LOGSOFTMAX_OUT=1
export TFS_SCOPE_LOSS_ROW_TILE=300000 TFS_COMPACT_DW_T4=1
export SCOPE_OUTPUT="$root/results/native_logits_v2_generalization/d${dim}_${threads}t.json"
export TFS_WORKER_CPUS="$(taskset -pc $$ | sed 's/.*: //')"
mkdir -p "$root/results/native_logits_v2_generalization"
