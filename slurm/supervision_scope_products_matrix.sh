...
#SBATCH -t 01:00:00
#SBATCH --array=0-11%6
#SBATCH -J scope_prod_matrix
#SBATCH -o /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/matrix_%A_%a.out
#SBATCH -e /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/matrix_%A_%a.err
...
export SCOPE_THREADS=$threads SCOPE_LAYERS=$layers
export SCOPE_WARMUPS=3 SCOPE_REPEATS=20
export TFS_SCOPE_BACKWARD_ORDER=$requested_scope_order
export SCOPE_OUTPUT="$root/runs/products_scope_matrix_${TFS_SCOPE_BACKWARD_ORDER}_l${layers}_${threads}t.json"
