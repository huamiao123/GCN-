...
#SBATCH -t 00:50:00
#SBATCH --array=0-3%4
#SBATCH -J dw_t4_shape
#SBATCH -o /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/dw_t4_shape_%A_%a.out
#SBATCH -e /online1/huangjianqiang_group/hdacp1/wzh/tfs_supervision_scope_shadow_20260905/runs/dw_t4_shape_%A_%a.err
...
export SCOPE_OUT_DIM=$dim SCOPE_SYNTHETIC_LABELS=1 SCOPE_AB_KIND=dw
...
export SCOPE_OUTPUT="$root/results/native_dw_t4_generalization/d${dim}_${threads}t.json"
export TFS_WORKER_CPUS="$(taskset -pc $$ | sed 's/.*: //')"
mkdir -p "$root/results/native_dw_t4_generalization"
